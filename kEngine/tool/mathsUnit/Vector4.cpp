...
Vector4 ColorTo1(Vector4 colorBy255) {
	return { colorBy255.x / 255.0f, colorBy255.y / 255.0f, colorBy255.z / 255.0f, colorBy255.w / 255.0f };
}

Vector4 ColorTo255(Vector4 colorBy1) {
	return { colorBy1.x * 255.0f, colorBy1.y * 255.0f, colorBy1.z * 255.0f, colorBy1.w * 255.0f };
}
