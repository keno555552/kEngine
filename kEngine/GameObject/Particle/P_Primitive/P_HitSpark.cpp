#include "P_HitSpark.h"

P_HitSpark::P_HitSpark(kEngine* system) :Particle(system) {
...
P_HitSpark::~P_HitSpark() {}

void P_HitSpark::Update(Camera* camera) {
	/// パーティクル計算
...
void P_HitSpark::SetTextureHandle(int handle) {
