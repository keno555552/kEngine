...
IDxcBlob* Shader_compile::CompileShader(// CompilerするShaderファイルへのパス
	...
	assert(SUCCEEDED(hr));
	// 成功したログを出す
	Logger::Log(ConvertString::SwitchStdStringWstring(std::format(L"Compile Succeeded, path:{}, profile:{}\n", filePath, profile)));
	// もう使わないリソースを解放
