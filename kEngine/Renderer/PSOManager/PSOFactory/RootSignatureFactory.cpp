...
RootSignatureFactory::RootSignatureFactory() {
	...
	rootSignatureRegistry[RenderModelType::Sprite2D] = [this](DirectXCore* directXDriver_) { return MakeStatic(directXDriver_); };
	rootSignatureRegistry[RenderModelType::Static] = [this](DirectXCore* directXDriver_) { return MakeStatic(directXDriver_); };
	rootSignatureRegistry[RenderModelType::Skinned] = [this](DirectXCore* directXDriver_) { return MakeStaticSkinning(directXDriver_); };
	rootSignatureRegistry[RenderModelType::PARTICLEENVREFLECTION] = [this](DirectXCore* directXDriver_) { return MakeStaticREFLECTION(directXDriver_); };
	rootSignatureRegistry[RenderModelType::DebugLine] = [this](DirectXCore* directXDriver_) { return MakeStatic(directXDriver_); };
	rootSignatureRegistry[RenderModelType::SkyCube] = [this](DirectXCore* directXDriver_) { return MakeStatic(directXDriver_); };
	rootSignatureRegistry[RenderModelType::FlameNeonGlow] = [this](DirectXCore* directXDriver_) { return MakeStatic(directXDriver_); };
}
...
Microsoft::WRL::ComPtr <ID3D12RootSignature> RootSignatureFactory::Make(PSOKey& key, DirectXCore* directXDriver_) {
	...
	if (it == rootSignatureRegistry.end()) {
		...
		auto rootSignature = it->second(directXDriver_);
...
Microsoft::WRL::ComPtr <ID3D12RootSignature> RootSignatureFactory::MakeStatic(DirectXCore* directXDriver_) {
...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::MakeStaticREFLECTION(DirectXCore* directXDriver_) {
...
Microsoft::WRL::ComPtr <ID3D12RootSignature> RootSignatureFactory::MakeStaticSkinning(DirectXCore* directXDriver_) {
	...
	rootParameters[7].DescriptorTable.pDescriptorRanges = wellRange;
	rootParameters[7].DescriptorTable.NumDescriptorRanges = _countof(wellRange);
